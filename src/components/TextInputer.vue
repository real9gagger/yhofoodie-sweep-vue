<template>
	<div class="hi-f bg-f0">
		<div class="fx-hc bg-mcff bg-lg-l1 hi-2rem8 pd-lr-rem5">
			<back-button class="fx-g1"></back-button>
			<div class="fx-g3 ta-c">{{myTitle}}</div>
			<div class="fx-g1 ta-r" @click="onDone">完成</div>
		</div>
		<div class="ps-r" id="textInputerContentBox">
			<input v-if="boxType==='number'" v-model="inputValue" type="number" class="text-inputer-box ta-c fs-1rem5 ls-2px" placeholder="请输入数字" />
